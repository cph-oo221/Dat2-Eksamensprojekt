...
public class Makeorder extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        int shedLength = Integer.parseInt(request.getParameter("shedLenght"));
        ...
        try
        {
            ...
            List<WoodOrderItem> woodOrderItemList = PartsListCalculator.finalCalc(length, width, shedLength, withRoof, withShed connectionPool);
